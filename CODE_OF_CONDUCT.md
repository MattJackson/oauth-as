...
This project uses the Contributor Covenant, version 2.1, as its code of conduct, verbatim. The
canonical text lives at https://www.contributor-covenant.org/version/2/1/code_of_conduct/ and
supersedes any copy below if the two ever diverge.
...
> PLACEHOLDER: the owner must fill in a reporting contact here (an email address or another
> reachable channel). Do not use this project's SECURITY.md process for conduct reports; that
> channel is for vulnerability disclosure, not conduct.
